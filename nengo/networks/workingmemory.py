...
class FeedbackGatedMemory(nengo.Network):
    ...
    def __init__(self, n_neurons, dimensions, fdbk_synapse=0.1,
                 ...
                 reset_gain=3, label=None, seed=None, add_to_container=None,
                 **ens_args):
        super(FeedbackGatedMemory, self).__init__(
        ...
        with self:
            ...
            self.in_gate = EnsembleArray(n_neurons, dimensions,
                                         label="in_gate", **ens_args)
